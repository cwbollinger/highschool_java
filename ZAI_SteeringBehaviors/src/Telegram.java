...
class Telegram
{
  ...
  Telegram(double time, int sender, int receiver, int msg, String info) {
	  DispatchTime = time;
	  Sender = sender;
      Receiver = receiver;
      Msg = msg;
...
static double SmallestDelay = 0.25;


static boolean equals( Telegram t1,  Telegram t2)
{
...
boolean notequals( Telegram t1, Telegram t2)
{
  if (t1 == t2)
  {
    return false;
